...
- [ ] Minor car silhouette polish (small shape cues only).
- [ ] Decide + document car reordering mechanic (and implement if approved).
- [ ] Add Armored + Ranger enemies.
- [ ] Add UI scale toggle (small/medium/large).
- [ ] Add audio + light VFX polish.
- [ ] Balance wave scaling, pickups, and tier growth.
